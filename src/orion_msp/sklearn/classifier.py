...
class OrionMSPClassifier(ClassifierMixin, BaseEstimator):
    ...
    of transformed datasets views to improve prediction accuracy. The ensemble members
    ...
    ensemble_generator_ : EnsembleGenerator
        Fitted ensemble generator that creates multiple datasets views.
    ...
    def fit(self, X, y):
        ...
        3. Fitting the ensemble generator to create transformed datasets views
        ...
        # Fit ensemble generator to create multiple datasets views
    ...
    def predict_proba(self, X):
        ...
        # May be fewer than requested if datasets has quite limited features and classes
